...
extension Sign_In_ViewController {
...
//        }
    ...
    func func_SetDesign() {
        ...
        let dontRange = (attributedString.string as NSString).range(of: "Signup")
    ...
    func func_Set_Shadow() {
        ...
        view_Credentials.layer.shadowOpacity = 33.0
        // shadow opacity ---> uper uthane k liye
